...
BILIBILI_DOMAIN = 'https://{}.bilibili.com'
BILIPLUS_API_URL = 'https://www.biliplus.com/api'

WWW_SUBDOMAIN = BILIBILI_DOMAIN.format('www')
API_SUBDOMAIN = BILIBILI_DOMAIN.format('api')
PASSPORT_SUBDOMAIN = BILIBILI_DOMAIN.format('passport')
SPACE_SUBDOMAIN = BILIBILI_DOMAIN.format('space')
BANGUMI_SUBDOMAIN = BILIBILI_DOMAIN.format('bangumi')
INTERFACE_SUBDOMAIN = BILIBILI_DOMAIN.format('interface')

VIEW_URL = API_SUBDOMAIN + '/view?{}'
# LIST_URL = API_SUBDOMAIN + '/list?{}'
DYNAMIC_URL = API_SUBDOMAIN + '/x/feed/pull?type=0&ps={}&pn={}'
# SP_URL = API_SUBDOMAIN + '/sp'
LOGIN_URL = PASSPORT_SUBDOMAIN + '/web/login'
LOGIN_CAPTCHA_URL = PASSPORT_SUBDOMAIN + '/captcha?r={}'
LOGIN_HASH_URL = PASSPORT_SUBDOMAIN + '/login?act=getkey&r={}'
HISTORY_URL = API_SUBDOMAIN + '/x/v2/history?pn={}&ps={}'
WATCH_LATER_URL = API_SUBDOMAIN + '/x/v2/history/toview/web?jsonp=jsonp&pn={}&ps={}&_={}'
FAV_BOX_URL = SPACE_SUBDOMAIN + '/ajax/fav/getBoxList?mid={}'
FAV_URL = SPACE_SUBDOMAIN + '/ajax/fav/getList?mid={}&page={}&pagesize={}&fid={}'
# TIMELINE_URL = BANGUMI_SUBDOMAIN + '/jsonp/timeline_v2.ver?callback=timeline'
...
# ADD_HISTORY_URL = INTERFACE_SUBDOMAIN + '/player?id=cid:{}&aid={}'
